    ...
    <b-card no-body>
      ...
      <b-card-header header-tag="nav">
        <b-nav card-header tabs fill>
          <b-nav-item @click="tabNo=1" active >Buyer Profile</b-nav-item>
          <b-nav-item @click="tabNo=2">Order History</b-nav-item>
        </b-nav>
      </b-card-header>
      <Address></Address>
      <hr class="my-4">
      ...
      <div v-if="tabNo===2">
        <b-card-header header-tag="nav">
        <b-nav card-header tabs fill>
          <b-nav-item @click="tabNo=1">Buyer Profile</b-nav-item>
          <b-nav-item @click="tabNo=2" active>Order History</b-nav-item>
        </b-nav>
      </b-card-header>
