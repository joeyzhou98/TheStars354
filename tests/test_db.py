...
buyer.save_to_db()
buyer.set_paypal("paypal")

seller = UserAuthModel(uid=333, username="seller", useremail="seller@concordia.ca", password="seller")
seller.save_to_db()

item1 = Item(item_id=123, item_name="item1", price=20, category="Book", brand="brand1",
             description="description1", seller_id=333, quantity=40)
item1.save_to_db()
item2 = Item(item_id=133, itemName="item2", price=10, category="Bok", brand="brand1",
             description="description2", seller_id=333, quantity=30)
item2.save_to_db()
